...
\begin{definition}
Given two topologies $\mathcal{T}1$ and $\mathcal{T}_2$ on the same set, we say $\mathcal{T}_1$ is \vocab{coarser} than $\mathcal{T}_2$ if $\mathcal{T}_1\subseteq\mathcal{T}2$.
\end{definition}
