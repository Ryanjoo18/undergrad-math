...
\begin{exercise}
Prove the Fundamental Theorem of Arithmetic, which states that every natural number greater than 1 may be expressed as a product of one or more prime numbers.
\end{exercise}
...
Induction can be generalised to give the well-ordering principle:
